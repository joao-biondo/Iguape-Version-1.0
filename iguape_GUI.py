...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.LNLS_logo, 0, 3, 1, 1)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Icons/Refresh_Icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Icons/peak_fit_icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.peak_fit_button.setIcon(icon2)
